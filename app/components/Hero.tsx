  ...
  return (
    <Link to={`/collections/${handle}`}>
      ...
      >
        ...
        <div className="flex flex-col items-baseline justify-between gap-4 px-6 py-8 sm:px-8 md:px-12 bg-gradient-to-t dark:from-contrast/60 dark:text-body from-primary/60 text-contrast">
          {heading?.value && (
