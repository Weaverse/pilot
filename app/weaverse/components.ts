...
import * as Countdown from '~/sections/countdown2/countdown2';
import * as ButtonCountDownItems from '~/sections/countdown2/actions';
import * as CountDownTimer from '~/sections/countdown2/timer2';
